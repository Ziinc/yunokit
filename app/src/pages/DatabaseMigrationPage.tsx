...
const DatabaseMigrationPage = ({ workspaceId }) => {
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-6">
            <Collapsible
              open={showExecutedMigrations}
              onOpenChange={setShowExecutedMigrations}
            >
                ...
                <Button variant="outline" size="sm" className="gap-2 w-full">
                  <ChevronDown
                    ...
                    className={`transform transition-transform ${
                      showExecutedMigrations ? "rotate-180" : ""
                    }`}
                  />
                  <span>
                    Show Executed Migrations ({executedMigrations.length})
                  </span>
                </Button>
              </CollapsibleTrigger>
      ...
      <Alert>
        ...
        <AlertDescription>
          Always backup your database before applying migrations. Rollbacks may
          result in data loss.
        </AlertDescription>
      </Alert>
    </div>
