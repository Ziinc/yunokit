  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
              ...
              <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Create a new system author for automated content
                      publishing.
                    </DialogDescription>
                  </DialogHeader>
                  <form onSubmit={handleAddSystemAuthor}>
                    <div className="py-4 space-y-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setNewAuthorDescription(e.target.value)
                          }
                    ...
                    <DialogFooter>
                      ...
                      <Button type="submit" disabled={!newAuthorName.trim()}>
                        Add Author
                      </Button>
                    </DialogFooter>
                  </form>
        ...
        <div
          className={
            isFeatureEnabled(FeatureFlags.SYSTEM_AUTHORS) ? "border-t pt-6" : ""
          }
        >
