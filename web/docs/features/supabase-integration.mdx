...
To connect your Supabase project to Supacontent:

1. Navigate to the **Settings > Supabase** page in your Supacontent workspace
...
When you connect Supacontent to Supabase:
...
- You'll need to reconnect your account to resume using Supacontent with Supabase
