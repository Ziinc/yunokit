...
description: Guide to managing database migrations in Supacontent
sidebar_position: 6
---
...
Database migrations in Supacontent are managed through Supabase migrations, providing version control for your database schema.
